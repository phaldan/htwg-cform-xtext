...
public class PsiInternalCalculatorFormParser extends AbstractPsiAntlrParser {
    ...
    // PsiInternalCalculatorForm.g:59:1: ruleModel returns [Boolean current=false] : ( (lv_greetings_0_0= ruleGreeting ) )* ;
    public final Boolean ruleModel() throws RecognitionException {
        ...
        try {
            // PsiInternalCalculatorForm.g:60:1: ( ( (lv_greetings_0_0= ruleGreeting ) )* )
            // PsiInternalCalculatorForm.g:61:2: ( (lv_greetings_0_0= ruleGreeting ) )*
            {
            // PsiInternalCalculatorForm.g:61:2: ( (lv_greetings_0_0= ruleGreeting ) )*
            loop1:
            do {
                ...
                switch (alt1) {
            	case 1 :
            	    // PsiInternalCalculatorForm.g:62:3: (lv_greetings_0_0= ruleGreeting )
            	    {
            	    // PsiInternalCalculatorForm.g:62:3: (lv_greetings_0_0= ruleGreeting )
            	    // PsiInternalCalculatorForm.g:63:4: lv_greetings_0_0= ruleGreeting
            	    {
    ...
    // PsiInternalCalculatorForm.g:79:1: entryRuleGreeting returns [Boolean current=false] : iv_ruleGreeting= ruleGreeting EOF ;
    public final Boolean entryRuleGreeting() throws RecognitionException {
        ...
        try {
            // PsiInternalCalculatorForm.g:79:50: (iv_ruleGreeting= ruleGreeting EOF )
            // PsiInternalCalculatorForm.g:80:2: iv_ruleGreeting= ruleGreeting EOF
            {
    ...
    // PsiInternalCalculatorForm.g:86:1: ruleGreeting returns [Boolean current=false] : (otherlv_0= 'Hello' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= '!' ) ;
    public final Boolean ruleGreeting() throws RecognitionException {
        ...
        try {
            // PsiInternalCalculatorForm.g:87:1: ( (otherlv_0= 'Hello' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= '!' ) )
            // PsiInternalCalculatorForm.g:88:2: (otherlv_0= 'Hello' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= '!' )
            {
            // PsiInternalCalculatorForm.g:88:2: (otherlv_0= 'Hello' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= '!' )
            // PsiInternalCalculatorForm.g:89:3: otherlv_0= 'Hello' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= '!'
            {
