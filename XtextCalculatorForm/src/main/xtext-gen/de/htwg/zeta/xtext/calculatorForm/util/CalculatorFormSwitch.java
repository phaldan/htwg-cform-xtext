...
public class CalculatorFormSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case CalculatorFormPackage.FIELD:
      {
        ...
        if (result == null) result = caseInputVariable(field);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case CalculatorFormPackage.FIELD_INPUT:
      {
        ...
        if (result == null) result = caseInputVariable(fieldInput);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case CalculatorFormPackage.FIELD_SELECT:
      {
        ...
        if (result == null) result = caseInputVariable(fieldSelect);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case CalculatorFormPackage.FIELD_CHOICE:
      {
        ...
        if (result == null) result = caseInputVariable(fieldChoice);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case CalculatorFormPackage.BUTTON:
      {
        ...
        if (result == null) result = caseInputVariable(button);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case CalculatorFormPackage.BUTTON_SUBMIT:
      {
        ...
        if (result == null) result = caseInputVariable(buttonSubmit);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        CalculateVariable calculateVariable = (CalculateVariable)theEObject;
        T result = caseCalculateVariable(calculateVariable);
        if (result == null) result = caseResultOutput(calculateVariable);
        if (result == null) result = caseInputVariable(calculateVariable);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case CalculatorFormPackage.INPUT_VARIABLE:
      {
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Calculate Variable</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Calculate Variable</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseCalculateVariable(CalculateVariable object)
  {
    return null;
  }
