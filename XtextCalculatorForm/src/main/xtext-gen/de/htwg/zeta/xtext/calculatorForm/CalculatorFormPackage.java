...
public interface CalculatorFormPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link de.htwg.zeta.xtext.calculatorForm.impl.CalculateVariableImpl <em>Calculate Variable</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.htwg.zeta.xtext.calculatorForm.impl.CalculateVariableImpl
   * @see de.htwg.zeta.xtext.calculatorForm.impl.CalculatorFormPackageImpl#getCalculateVariable()
   * @generated
   */
  int CALCULATE_VARIABLE = 18;
   ...
   * @ordered
   */
  int CALCULATE_VARIABLE__NAME = RESULT_OUTPUT_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Calculate Variable</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int CALCULATE_VARIABLE_FEATURE_COUNT = RESULT_OUTPUT_FEATURE_COUNT + 1;
  ...
  /**
   * The meta object id for the '{@link de.htwg.zeta.xtext.calculatorForm.impl.InputVariableImpl <em>Input Variable</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.htwg.zeta.xtext.calculatorForm.impl.InputVariableImpl
   * @see de.htwg.zeta.xtext.calculatorForm.impl.CalculatorFormPackageImpl#getInputVariable()
   * @generated
   */
  int INPUT_VARIABLE = 22;
   ...
   * @ordered
   */
  int INPUT_VARIABLE_FEATURE_COUNT = 0;
  ...
  /**
   * The meta object id for the '{@link de.htwg.zeta.xtext.calculatorForm.impl.ReferenceLiteralImpl <em>Reference Literal</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.htwg.zeta.xtext.calculatorForm.impl.ReferenceLiteralImpl
   ...
   * @ordered
   */
  int REFERENCE_LITERAL__REF = LITERAL_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Reference Literal</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int REFERENCE_LITERAL_FEATURE_COUNT = LITERAL_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for class '{@link de.htwg.zeta.xtext.calculatorForm.CalculateVariable <em>Calculate Variable</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Calculate Variable</em>'.
   * @see de.htwg.zeta.xtext.calculatorForm.CalculateVariable
   * @generated
   */
  EClass getCalculateVariable();

  /**
   * Returns the meta object for the attribute '{@link de.htwg.zeta.xtext.calculatorForm.CalculateVariable#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.htwg.zeta.xtext.calculatorForm.CalculateVariable#getName()
   * @see #getCalculateVariable()
   * @generated
   */
  EAttribute getCalculateVariable_Name();
  ...
  /**
   * Returns the meta object for class '{@link de.htwg.zeta.xtext.calculatorForm.InputVariable <em>Input Variable</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Input Variable</em>'.
   * @see de.htwg.zeta.xtext.calculatorForm.InputVariable
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link de.htwg.zeta.xtext.calculatorForm.ReferenceLiteral <em>Reference Literal</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Reference Literal</em>'.
   * @see de.htwg.zeta.xtext.calculatorForm.ReferenceLiteral
   * @generated
   */
  EClass getReferenceLiteral();

  /**
   * Returns the meta object for the reference '{@link de.htwg.zeta.xtext.calculatorForm.ReferenceLiteral#getRef <em>Ref</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Ref</em>'.
   * @see de.htwg.zeta.xtext.calculatorForm.ReferenceLiteral#getRef()
   * @see #getReferenceLiteral()
   * @generated
   */
  EReference getReferenceLiteral_Ref();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link de.htwg.zeta.xtext.calculatorForm.impl.CalculateVariableImpl <em>Calculate Variable</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.htwg.zeta.xtext.calculatorForm.impl.CalculateVariableImpl
     * @see de.htwg.zeta.xtext.calculatorForm.impl.CalculatorFormPackageImpl#getCalculateVariable()
     * @generated
     */
    EClass CALCULATE_VARIABLE = eINSTANCE.getCalculateVariable();
     ...
     * @generated
     */
    EAttribute CALCULATE_VARIABLE__NAME = eINSTANCE.getCalculateVariable_Name();
    ...
    /**
     * The meta object literal for the '{@link de.htwg.zeta.xtext.calculatorForm.impl.InputVariableImpl <em>Input Variable</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.htwg.zeta.xtext.calculatorForm.impl.InputVariableImpl
     * @see de.htwg.zeta.xtext.calculatorForm.impl.CalculatorFormPackageImpl#getInputVariable()
    ...
    /**
     * The meta object literal for the '{@link de.htwg.zeta.xtext.calculatorForm.impl.ReferenceLiteralImpl <em>Reference Literal</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.htwg.zeta.xtext.calculatorForm.impl.ReferenceLiteralImpl
     * @see de.htwg.zeta.xtext.calculatorForm.impl.CalculatorFormPackageImpl#getReferenceLiteral()
     * @generated
     */
    EClass REFERENCE_LITERAL = eINSTANCE.getReferenceLiteral();
     ...
     * @generated
     */
    EReference REFERENCE_LITERAL__REF = eINSTANCE.getReferenceLiteral_Ref();
